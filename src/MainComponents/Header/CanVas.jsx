...
<span className="position-relative">
       <div className="icaryio position-absolute p-1 z-3 text-wight rounded-pill  bg-danger  "> {fovouriteArticles.length}</div><div className="cary position-relative   p-1 rounded-pill  "> <i class="fa-solid fa-cart-shopping"></i></div>
</span>
      </button>
